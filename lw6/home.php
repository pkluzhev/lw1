...
$featuredPosts = [];
$mostRecent = [];
getDataFromDB($featuredPosts, $mostRecent, $conn);
...
<head>
    ...
    <script src="burger-menu.js" type="text/javascript" defer></script>
    ...
    <footer class="footer">
        <nav class="footer__navigation navigation container">
            <div class="navigation__block">
                ...
                <ul class="navigation__list navigation__list_footer">
