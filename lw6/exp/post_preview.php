...
<a class="card <?= getModifier('card_', $post['is_feautured']) ?>" style="background-image: url('<?= $post['image_preview_url'] ?>');" href="/post?id=<?= $post['id'] ?>">
    ...
    <?php if (isset($post['sticker']) && $post['sticker']) : ?>
